...
if($settings['online_members_count']){
    $data = db_qr_fetch("select count(*) as count from ".members_table_replace("movies_members")." where ".members_fields_replace("last_login")." >= ".connector_get_date($timeout,'member_last_login'),MEMBER_SQL);
