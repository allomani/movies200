...
$member_table_tofind ="movies_members";
...
$qr=db_query("select ".members_fields_replace('password').",salt from ".members_table_replace('movies_members')." where ".members_fields_replace('id')."='$userid'",MEMBER_SQL);
